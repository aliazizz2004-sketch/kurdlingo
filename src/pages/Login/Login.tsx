...
const Login: React.FC = () => {
    ...
    // Auto-redirect to learn if already logged in
    useEffect(() => {
        if (isLoaded && user) {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (data.session) {
            // Go to landing page which will then redirect to /learn
    ...
    const handleGoogleLogin = async () => {
        ...
        if (error) {
            setError('هەڵەیەک ڕوویدا لە کاتی چوونەژوورەوە بە Google، تکایە دووبارە هەوڵبدەرەوە.');
            setGoogleLoading(false);
        }
        // Note: for OAuth the page will redirect away, so no need to handle success here
    };
                ...
                <div className="login-form-side">
                    <div className="login-form-inner">
                        ...
                        >
                            ...
                            <span>{googleLoading ? 'چاوەڕێ بکە...' : 'چوونەژوورەوە بە Google'}</span>
                        </button>
