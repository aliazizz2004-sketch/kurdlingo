      ...
      try {
        ...
        if (msg.id === 1) { // initialize response
          ...
          child.stdin.write(JSON.stringify({
            ...
            id: 2,
            method: 'tools/call',
            params: { name: 'get-backend-metadata', arguments: {} }
          }) + '\n');
        } else if (msg.id === 2) { 
           fs.writeFileSync('C:\\Users\\TOTAL TECH\\Desktop\\My Ai project\\webapp\\Zheera\\mcp_metadata.json', JSON.stringify(msg, null, 2));
           process.exit(0);
        }
      } catch (e) {}
    }
